...
<style scoped>
.activity-card { overflow: hidden; }header { min-height: 60px; padding: 14px 18px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border); }header h2 { font-size: 16px; }.tabs { display: flex; gap: 2px; padding: 8px 18px 0; border-bottom: 1px solid var(--border); }.tabs button { border: 0; border-bottom: 2px solid transparent; padding: 10px 12px; color: var(--text-3); background: transparent; cursor: pointer; }.tabs button.active { color: var(--accent); border-bottom-color: var(--accent); }.activity-body { padding: 14px 18px 18px; }.activity-toolbar { min-height: 28px; display: flex; justify-content: flex-end; align-items: center; gap: 10px; margin-bottom: 8px; }.scope-switch { display: flex; margin-right: auto; border: 1px solid var(--border); border-radius: 8px; overflow: hidden; }.scope-switch button { border: 0; padding: 6px 10px; color: var(--text-2); background: transparent; cursor: pointer; }.scope-switch button.active { color: var(--accent); background: var(--bg-panel-2); }.panel-state { color: var(--text-3); font: 600 10px var(--font-mono); }.panel-state--current { color: var(--up); }.panel-state--last-good { color: var(--warn); }.panel-state--unavailable { color: var(--down); }.panel-warning { padding: 8px 10px; color: #805700; background: #fff8df; font-size: 11px; }.record-table { overflow-x: auto; border: 1px solid var(--border); border-radius: var(--radius-sm); }.record-head,.record-row { min-width: 960px; align-items: center; gap: 12px; padding: 10px 12px; font-size: 11px; }.record-head { color: var(--text-3); background: var(--bg-panel-2); font-weight: 600; }.record-row { width: 100%; border: 0; border-top: 1px solid var(--border); text-align: left; color: var(--text-1); background: var(--bg-panel); }.record-row.clickable { cursor: pointer; }.record-row.clickable:hover { background: var(--bg-panel-2); }.order-grid { display: grid; grid-template-columns: 1.2fr .55fr .75fr .75fr .75fr .9fr .6fr; }.trade-grid { display: grid; grid-template-columns: 1fr .5fr .7fr .7fr .55fr 1.3fr 1fr; }.ledger-grid { display: grid; grid-template-columns: 1fr .45fr .65fr .8fr 1fr 1.25fr .8fr; }.buy,.credit { color: var(--up); }.sell,.debit { color: var(--down); }.cancel { border: 0; color: var(--down); background: transparent; cursor: pointer; }.empty { padding: 20px; color: var(--text-3); text-align: center; font-size: 12px; }
</style>
